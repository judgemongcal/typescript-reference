...
var checkCourse = function (entry) {
    return "The course is called "
        .concat(entry.name, ", and it is taught by ")
        .concat(entry.instructor, ". It is ")
        .concat(entry.duration, " hours long");
};
checkCourse({
...
function printSong(song) {
    console.log(
        ""
            .concat(song.title, " is produced by ")
            .concat(song.credits.producer, " and written by ")
            .concat(song.credits.writer, ". \n    It currently has ")
            .concat(song.numStreams, " streams"),
    );
}
var mySong = {
